        ...
        case 'remove':
          if (chat.welcome) {
            ...
            for (let user of participants) {
              let kai = await(await fetch('https://telegra.ph/file/0b182506e001e0bbe1902.jpg')).buffer()
              let poi = await(await fetch('https://telegra.ph/file/0b182506e001e0bbe1902.jpg')).buffer()
